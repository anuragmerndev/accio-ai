"""macOS menu-bar app: wires hotkey to record to pipeline worker to paste.
...
def ensure_input_monitoring() -> bool:
    ...
    registers this binary in System Settings to Privacy to Input Monitoring
    ...
    try:
        ...
        if not granted:
            ...
            print(
                "Requested Input Monitoring. Enable Accio in System Settings to "
                "Privacy & Security to Input Monitoring, then restart."
            )
        return granted
